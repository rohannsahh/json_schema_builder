...
// const FieldRow = ({ index, field, onChange, onDelete }) => {
...
//     const updatedField = { ...field, fields: nestedFields };
//     onChange(index, updatedField);
//   };

//   return (
//     <div style={{ marginBottom: "10px", marginLeft: "10px", borderLeft: "2px solid #ccc", paddingLeft: "10px" }}>
//       <input
//         type="text"
